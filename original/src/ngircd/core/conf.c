...
{
	LogDebug("Read_Config_File(): %s", File);
...
#ifdef NGIRCD_UNITTEST
GLOBAL void Conf_Test_SetDefaults(bool InitServers) { Set_Defaults(InitServers); }
GLOBAL bool Conf_Test_ValidateConfig(bool TestOnly, bool Rehash) { return Validate_Config(TestOnly, Rehash); }
GLOBAL void Conf_Test_Handle_GLOBAL(const char *File, int Line, char *Var, char *Arg) { Handle_GLOBAL(File, Line, Var, Arg); }
GLOBAL void Conf_Test_Handle_LIMITS(const char *File, int Line, char *Var, char *Arg) { Handle_LIMITS(File, Line, Var, Arg); }
GLOBAL void Conf_Test_Handle_OPTIONS(const char *File, int Line, char *Var, char *Arg) { Handle_OPTIONS(File, Line, Var, Arg); }
GLOBAL void Conf_Test_Handle_OPERATOR(const char *File, int Line, char *Var, char *Arg) { Handle_OPERATOR(File, Line, Var, Arg); }
GLOBAL void Conf_Test_Handle_SERVER(const char *File, int Line, char *Var, char *Arg) { Handle_SERVER(File, Line, Var, Arg); }
GLOBAL void Conf_Test_Handle_CHANNEL(const char *File, int Line, char *Var, char *Arg) { Handle_CHANNEL(File, Line, Var, Arg); }
#endif
