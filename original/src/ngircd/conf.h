...
GLOBAL void Conf_Test_SetDefaults PARAMS((bool InitServers));
GLOBAL bool Conf_Test_ValidateConfig PARAMS((bool TestOnly, bool Rehash));
GLOBAL void Conf_Test_Handle_GLOBAL PARAMS((const char *File, int Line, char *Var, char *Arg));
GLOBAL void Conf_Test_Handle_LIMITS PARAMS((const char *File, int Line, char *Var, char *Arg));
GLOBAL void Conf_Test_Handle_OPTIONS PARAMS((const char *File, int Line, char *Var, char *Arg));
GLOBAL void Conf_Test_Handle_OPERATOR PARAMS((const char *File, int Line, char *Var, char *Arg));
GLOBAL void Conf_Test_Handle_SERVER PARAMS((const char *File, int Line, char *Var, char *Arg));
GLOBAL void Conf_Test_Handle_CHANNEL PARAMS((const char *File, int Line, char *Var, char *Arg));
#endif
