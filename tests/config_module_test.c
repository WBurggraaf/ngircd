/*
 * config_module_test.c — unit tests for the managed Config.dll API
 *
 * Links against the managed NativeAOT Config.dll (C# implementation).
 * No stub functions or portab needed — the managed DLL is self-contained.
 *
 * Tests:
 *   - config_get_api_v1()    struct integrity
 *   - get_bootstrap()        NULL guard and happy path
...
/* Forward-declare module_get_api_v1 exported by Config.dll */
